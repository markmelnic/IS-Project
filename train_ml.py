...
from bots.losingbot import losingbot

from bots.ml.ml import features

def create_dataset(path, player=losingbot.Bot(), games=2000, phase=1):
...
if options.overwrite or not os.path.isfile(options.dset_path):
    create_dataset(options.dset_path, player=losingbot.Bot(), games=10000)
